package org.study.spring.model.board.dto;
...
public class ReplyDTO {
	...
	public Date getMdydate() {
		return mdydate;
	}
	public void setMdydate(Date mdydate) {
	...
	public String toString() {
		return "ReplyDTO [rno=" + rno + ", bno=" + bno + ", replytext=" + replytext + ", replyer=" + replyer + ", name="
				+ name + ", regdate=" + regdate + ", mdydate=" + mdydate + ", secretReply=" + secretReply + ", writer="
				+ writer + "]";
	}
